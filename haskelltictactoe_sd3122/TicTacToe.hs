...
gameOver :: Board -> Bool
gameOver b = any checkForFilled [rows, cols, diags]
  where checkForFilled f = any (\x -> nub x `elem` [[Taken O], [Taken X]]) $ f b
