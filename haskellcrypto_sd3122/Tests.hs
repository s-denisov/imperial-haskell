...
affineEncryptTestCases
  = [ (5, 8, "affinecipher") ==> "ihhwvcswfrcp" ]

affineDecryptTestCases
  = [ (5, 8, "ihhwvcswfrcp") ==> "affinecipher" ]
...
allTestCases
  = [ TestCase "gcd" (uncurry Crypto.gcd)
    ...
    , TestCase "cbcDecrypt" (uncurry3 cbcDecrypt)
                       cbcDecryptTestCases
    , TestCase "affineEncrypt" (uncurry3 affineEncrypt) affineEncryptTestCases
    , TestCase "affineDecrypt" (uncurry3 affineDecrypt) affineDecryptTestCases
    ]
