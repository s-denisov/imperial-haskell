...
evalTests
  = [ ((Val 7),  [("x",380)])
    ...
    , ((UnApp Cos (Val 2.4)), [])
        ==> (-0.7373937155412454)
    , (UnApp Log (Id "a"), [("b", 2), ("a", 3)]) ==> 1.09861228867
    , ( e1, [("x",0.37)])
        ==> (1.85)
    ...
    , (e6, "x") ==>
        BinApp Div (BinApp Add (BinApp Add (BinApp Mul (Val 3.0)
                    ...
                    (BinApp Add (BinApp Mul (Val 3.0) (BinApp Mul (Id "x")
                                                                  (Id "x")))
                                (Val 2.0))
    , (UnApp Log (Id "x"), "x") ==> BinApp Div (Val 1) (Id "x")
    ]
...
newtonRaphsonTests
  = [ (UnApp Cos (Id "x") - x, 1, 5) ==> 0.7503638678402439
    ]
...
allTestCases
  = [ floatTestCase "eval"       (uncurry eval)       evalTests
    ...
    , floatTestCase "newton-raphson"  (uncurry3 newtonRaphson) newtonRaphsonTests
    ]
